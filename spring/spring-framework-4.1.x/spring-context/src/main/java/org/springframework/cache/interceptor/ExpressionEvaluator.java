...
class ExpressionEvaluator {
	...
	public boolean condition(String conditionExpression, MethodCacheKey methodKey, EvaluationContext evalContext) {
		boolean result =  getExpression(this.conditionCache, conditionExpression, methodKey).getValue(evalContext, boolean.class);
		return result;
	}

	public boolean unless(String unlessExpression, MethodCacheKey methodKey, EvaluationContext evalContext) {
		boolean result =   getExpression(this.unlessCache, unlessExpression, methodKey).getValue(evalContext, boolean.class);
		return result;
	}
